...
<div class="review_reply_conatiner">
	<h3 class="title">후기 답글 수정</h3>

	<form action="upDateRevAf.do" method="post" id="frm">
		...
		<table>
			<tr>
				...
				<td><input type="text" maxlength="200" class="form-control" id="title" value="<%=prodInfo.getTitle() %>" readonly="readonly" disabled="disabled"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea rows="10" cols="50" class="form-control" id="reply_content" name="content"><%=dto.getContent() %></textarea></td>
			</tr>
		</table>
